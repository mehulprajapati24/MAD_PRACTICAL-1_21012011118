...
class Car(var car_info:String, var owner:String, var milesDrive:Int, var original_price:Double, var current_price:Double)
{
    ...
    constructor():this("BMW, 2018", "MEHUL", 105, 100000.0, 98950.0)
...
fun main()
{
    ...
    //called init and
    val obj2 = Car("TOYOTA, 2017", "JAY", 100, 100800.0, 86950.0)
    obj2.displayCarInfo()
    ...
    val obj3 = Car()
    val obj4 = Car("Honda, 2015", "SAHIL", 110, 90000.0, 70500.50)
    val obj5 = Car("Maruti, 2020", "OM", 200, 4000000.0, 3998000.0)
